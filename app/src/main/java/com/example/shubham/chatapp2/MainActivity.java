...
public class MainActivity extends AppCompatActivity {
    ...
    private FirebaseRecyclerAdapter<ChatMessage,ChatMessageViewHolder> adapter;
    ...
    private void displayChatMessages() {
        ...
        adapter = new FirebaseRecyclerAdapter<ChatMessage, ChatMessageViewHolder>(ChatMessage.class,R.layout.message,ChatMessageViewHolder.class,FirebaseDatabase.getInstance().getReference()) {
            @Override
